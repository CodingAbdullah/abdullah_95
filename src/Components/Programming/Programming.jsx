...
const Programming = () => {
    ...
    return (
        <div className="programming-section">
                ...
                <p className="programming-paragraph-list">Some of the personal projects I've worked on are: <ul><li>Building a Personal Website (this one!)</li><li>Building Websites (Search Engines, Landing Pages)</li></ul></p>
                ...
                <img className="programming-image" src={require("../../assets/images/programming.png")} alt="Not Found" />
        </div>
    )
}
